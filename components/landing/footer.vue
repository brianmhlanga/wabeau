  ...
  <div class="">
    <div class="grid grid-nogutter surface-section px-4 py-4 md:px-6 lg:px-8 border-top-1 surface-border">
      <div class="col-12 lg:col-6 lg:border-right-1 surface-border">
        <img src="/images/logo.png" class="w-9rem mx-auto lg:mx-0" alt="Peak logo">
        <span class="text-900 block mt-4 mr-3">Welcome to Wabeau, your ultimate runway to the world of glamour and style! Wabeau is more than just a platform; it's a stage where aspiring models showcase their unique charisma and where fashion enthusiasts become the judges. Dive into the pulse of the latest trends, discover breathtaking talent, and cast your votes to shape the next fashion icon</span>
        <span class="text-500 block mt-4">© 2024, Wabeau. <a href="https://www.webdev.co.zw/">Powered by Webdev Group</a></span>
      </div>
