<template>
    <NuxtLayout name="dashboard">
      <div class="page-content">
			    <h1 class="page-title">Participants Page</h1>

				 <div class="card radius-10">
					<div class="card-header">
						<div class="d-flex align-items-center">
							<div>
								<h6 class="mb-0">Participants for {{ competition_name }} </h6>
                    ...
                    <Column field="price" header="Current Competition Level">
                        <template #body="slotProps">
                            {{slotProps.data.competition_level }}
                        </template>
                    </Column>
                    <Column field="price" header="Current Competition Level">
                        <template #body="slotProps">
                    ...
                    <Column header="Likes">
                        <template #body="slotProps">
                            {{slotProps.data.likes ? slotProps.data.likes.length : 0 }}
                        </template>
                    </Column>
                    <Column header="Votes">
                        <template #body="slotProps">
                            {{slotProps.data.votes ? slotProps.data.votes.length : 0 }}
                        </template>
                    </Column>
