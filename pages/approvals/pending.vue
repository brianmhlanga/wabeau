<template>
    <NuxtLayout name="dashboard">
        <section class="section">
            <div class="container-fluid pt-5">
                <div class="row">                  
                    <div  class="text-900 font-medium text-xl mb-3">My Approvals</div>
                        ...
                        <div class="grid formgrid p-fluid">
                            <div  class="field mb-4 col-12 md:col-12"> 
                                ...
                                <DataTable :value="requisitions" showGridlines tableStyle="min-width: 50rem">
                                    ...
                                    <Column field="rating" header="Originator">
                                        <template #body="slotProps">
                                    ...
                                    <Column header="Actions">
                                       <template #body="slotProps">
                                           <Button  @click="navigateTo(`detail-${slotProps?.data?.id}`)" icon="pi pi-eye" outlined rounded class="mr-2"/>
                                       </template>
                                   </Column>
                                </DataTable>
                            </div>
 ...
 <script setup lang="ts">
    ...
    onMounted( async ()=> {
        ...
        let approvals = await sageStore.getApprovals(id).then((data)=> {
